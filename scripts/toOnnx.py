...
Controller code should feed deployment observations with a 34-float ``vec``
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--vec-dim", type=int, default=34, help="Vector observation dimension.")
    ...
    parser.add_argument("--aux-dim", type=int, default=6, help="Auxiliary vector tail dimension.")
    parser.add_argument(
        "--batch-size",
        type=int,
        default=1,
