...
All the environments are registered in the `pirl` extension. They start
...
def main():
    """Print all environments registered in `pirl` extension."""
    ...
    for task_spec in gym.registry.values():
        if task_spec.id.startswith("burger") and (
